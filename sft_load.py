...
from medical_utils import get_questions2, get_questions2_hard, get_mokeqa, formatting_prompts_func, create_test_func
...
def inference(prompts, model, tokenizer, max_new_tokens=256):
    """
    执行推理的通用函数
...
if __name__ == "__main__":
    ...
    test_prompts = [
        dataset[110]['instruction'],
        dataset[111]['instruction']
    ]
